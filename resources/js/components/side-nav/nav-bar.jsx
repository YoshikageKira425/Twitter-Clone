                ...
                <ul className="space-y-2">
                    ...
                    <li>
                        <a
                            ...
                            className="flex items-center gap-2 rounded-full px-4 py-3 transition duration-200 hover:bg-neutral-800"
                        >
                            <img
                    ...
                    <li>
                        <button
                            onClick={logOut}
                            className="flex w-full items-center gap-4 rounded-full px-4 py-3 transition duration-200 hover:bg-neutral-800"
                        >
