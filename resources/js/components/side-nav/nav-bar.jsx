...
import { FiBell, FiHash } from 'react-icons/fi';
        ...
        <>
            <div className="flex h-screen w-full flex-col p-4 text-white">
                ...
                <ul className="space-y-2">
                    ...
                    <li>
                        <a href={`/account/${auth.user.name}`} className="flex items-center gap-4 rounded-full px-4 py-3 transition duration-200 hover:bg-neutral-800">
                            <img
