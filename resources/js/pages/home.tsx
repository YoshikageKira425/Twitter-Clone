...
export default function Home() {
    ...
    return (
        <div className="flex h-screen bg-black text-gray-100">
            <div className="fixed w-1/5 h-full border-r border-gray-800 overflow-y-auto">
                <NavBar />
            </div>

            <div className="w-3/5 flex-grow border-r border-gray-800 ml-[20%] mr-[25%]">
            ...
            <div className="fixed right-0 top-0 w-1/4 h-full border-l border-gray-800 overflow-y-auto">
                <div className="p-4">
